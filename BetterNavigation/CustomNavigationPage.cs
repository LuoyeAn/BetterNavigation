...
namespace BetterNavigation
{
    public class CustomNavigationPage : NavigationPage
    {
        ...
        public static readonly BindableProperty TitlePositionProperty = BindableProperty.CreateAttached("TitlePosition", typeof(TitleAlignment), typeof(CustomNavigationPage), TitleAlignment.Center);
